    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Pengembalian</h1>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pt-2">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a id="add-user" href="{{ route('pengembalian.create') }}" class="btn fw-bold btn-sm btn-primary">
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, row) {
                            let detailRoute = "{{ route('pengembalian.show', ':id') }}".replace(':id', row.id);
                            let editRoute = "{{ route('pengembalian.edit', ':id') }}".replace(':id', row.id);

                            let editButton = `
                                <a href="${detailRoute}" class="btn btn-sm btn-light-success" title="Detail">
