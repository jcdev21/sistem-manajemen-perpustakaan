    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Peminjaman</h1>
            </div>
        </div>
    </div>
                ...
                <div class="card-header pt-2">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <a id="add-user" href="{{ route('peminjaman.create') }}" class="btn fw-bold btn-sm btn-primary">
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return row.status === 'dipinjam' ? '<span class="badge badge-warning">Dipinjam</span>' : '<span class="badge badge-success">Dikembalikan</span>';
                        }
                    },
                    {
                        data: null,
